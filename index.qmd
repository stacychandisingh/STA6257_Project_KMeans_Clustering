...
table1 <- 
  spotify_new_df %>%
  tbl_summary(include = c(track_popularity, danceability, energy, key, loudness, mode))
...
# Update histogram to show one color of bars and make plots bigger
#spotify_new_df %>% inspect_num() %>% show_plot()

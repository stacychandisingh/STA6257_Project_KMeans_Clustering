...
In this paper, we explore the usefulness of K-Means clustering algorithm to gain insights using data from the open source website, Kaggle. The data focuses on features from the musical streaming platform, Spotify.

...
- ni is number of data points in cluster i. <br>
- C~i~ is centroid. <br>
...
spotify_new_df <- spotify_new_df %>% select(where(is.numeric))
#head(spotify_new_df)

# summarize the data with our package
table1 <- 
  spotify_new_df %>%
  tbl_summary(include = c(track_popularity,danceability,energy,key,loudness,mode,speechiness,
...
#hist(spotify_new_df$energy, main="Histogram of energy", col="skyblue")
#hist(spotify_new_df$track_popularity, main="Histogram of track popularity", col="skyblue")
#hist(spotify_new_df$danceability, main="Histogram of danceability", col="skyblue")
#hist(spotify_new_df$key, main="Histogram of key", col="skyblue")
#hist(spotify_new_df$loudness, main="Histogram of loudness", col="skyblue")
#hist(spotify_new_df$mode, main="Histogram of mode", col="skyblue")
#hist(spotify_new_df$speechiness, main="Histogram of speechiness", col="skyblue")
#hist(spotify_new_df$acousticness, main="Histogram of acousticness", col="skyblue")
#hist(spotify_new_df$instrumentalness, main="Histogram of instrumentalness", col="skyblue")
#hist(spotify_new_df$liveness, main="Histogram of liveness", col="skyblue")
#hist(spotify_new_df$valence, main="Histogram of valence", col="skyblue")
#hist(spotify_new_df$tempo, main="Histogram of tempo", col="skyblue")
#hist(spotify_new_df$duration_min, main="Histogram of duration in minutes", col="skyblue")
...
reduction <- sample(x = nrow(spotify_new_df), size = nrow(spotify_new_df)*0.015)
spotify_keep <- spotify_new_df[reduction,]

reduction2 <- sample(x = nrow(spotify_new_df), size = nrow(spotify_new_df)*0.2)
spotify_red2 <- spotify_new_df[reduction2,]

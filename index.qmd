...
We would like to see the number of popular songs in each cluster. Just like our previous analysis we take our spotify review set and see the number of popular tracks in each cluster based on our popularity score of >57. In cluster 1 there were 492 popular tracks, cluster 2 405 popular tracks, and cluster 3 1,241 popular tracks. The graph compares the groups as we use this new only_pop data to see what type of popular tracks are in each cluster.  
